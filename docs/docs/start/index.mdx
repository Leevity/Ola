---
title: Get started
description: Install, configure, and run your first Ola agent session.
---

# Get started

Ola 是一个开源桌面平台，用来让多个 AI Agent 在你的本地项目里协作。它提供本地文件读写、Shell、代码搜索、上下文感知、子代理、团队协作以及人类审批机制。
