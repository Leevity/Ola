---
title: 会话与消息管理
description: Ola 的 project/session/message 模型和持久化结构。
---

# 会话与消息管理 / Sessions & Messages

Ola 使用的是 **project → session** 的结构，而不是单纯的“聊天列表”。这样做是为了把工作目录、SSH、插件和模型绑定到真实工作上下文里。
...
这让 Ola 能把“一个代码仓库 / 一个远程主机 / 一个插件聊天空间”当成真正的工作单元。
