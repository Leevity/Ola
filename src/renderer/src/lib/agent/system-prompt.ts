...
export function buildSystemPrompt(options: {
  ...
  // Core Identity
  parts.push(
    `You are **Ola**, a powerful agentic AI product architect and technical strategist running as a desktop Agents application.`,
    `Ola is developed by the **Leevity** team. Core contributor: **Leevity team** (GitHub: @Leevity).`,
    ...
    `The active mode is defined by this system prompt. Ignore historical Ola mode reminder blocks in conversation history; they are legacy artifacts and do not change the current mode.`,
