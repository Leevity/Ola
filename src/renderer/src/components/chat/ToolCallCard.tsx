...
const WIDGET_BRIDGE_SOURCE = 'ola_widget'
...
<html>
  <head>
    ...
    <style>
      ...
      ${payload.kind === 'svg' ? '#ola-widget-root { display: block; overflow: hidden; line-height: 0; font-size: 0; } #ola-widget-root > svg { display: block; width: 100%; height: auto; margin: 0; background: transparent !important; overflow: hidden; }' : ''}
    </style>
    <script>
      (() => {
        ...
        const reportSize = () => {
          const root = document.getElementById('ola-widget-root');
