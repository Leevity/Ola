...
This file stores global durable memory shared across Ola sessions.
...
function isMissingFileError(error: string): boolean {
  return /ENOENT|No such file|Could not find/i.test(error)
}
...
function GeneralPanel(): React.JSX.Element {
  ...
  const fontOptions = [
    ...
    },
    {
      ...
      value: "'Microsoft YaHei', 'PingFang SC', 'Hiragino Sans GB', system-ui, sans-serif"
    }
  ]
...
function AboutPanel(): React.JSX.Element {
  ...
  const modeCards = [
    {
      icon: MessagesSquare,
      title: t('about.featureCards.chat.title'),
      desc: t('about.featureCards.chat.desc')
    },
    {
      icon: MessageSquareQuote,
      title: t('about.featureCards.clarify.title'),
    ...
    {
      icon: Network,
      title: t('about.featureCards.acp.title'),
      desc: t('about.featureCards.acp.desc')
    }
  ]
  return (
    <div className="space-y-8">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-border/60 bg-gradient-to-br from-muted/60 via-background to-muted/40 p-6 shadow-inner">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <div className="space-y-1">
              ...
              <h3 className="text-2xl font-semibold text-foreground">Ola</h3>
