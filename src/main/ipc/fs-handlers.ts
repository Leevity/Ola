...
const MAX_FILE_READ_BYTES = readByteLimitFromEnv('OLA_MAX_FILE_READ_MB', 10, 1, 50)
const MAX_IMAGE_READ_BYTES = readByteLimitFromEnv('OLA_MAX_IMAGE_READ_MB', 10, 1, 20)
