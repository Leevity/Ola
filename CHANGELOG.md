...
- **Code-compatible tool** (`code-compatible-tool.ts`, 321 lines): New tool providing code-agent-compatible aliases for Ola's tool system, enabling seamless interoperability.
...
- Protected real Chrome/Edge/Brave/Chromium profiles by keeping Electron's writable browser session data inside Ola's isolated storage.
